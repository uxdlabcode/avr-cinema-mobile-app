                      ...
                      <CardContent className="px-3.5 flex items-start gap-3.5">
                        ...
                        <div className="shrink-0 self-center flex items-center gap-2">
                          <button 
                            ...
                            className="focusable focusable w-6 h-6 rounded-full hover:bg-muted flex items-center justify-center text-muted-foreground hover:text-primary transition-colors outline-none"
                    ...
                    >
                      <CardContent className="p-3.5 flex items-start gap-3.5">
                        ...
                        {/* <div className="shrink-0 self-center flex items-center gap-2">
                          <button 
                            onClick={(e) => handleToggleRead(e, item)}
                            className="focusable focusable w-6 h-6 rounded-full hover:bg-muted flex items-center justify-center text-muted-foreground hover:text-primary-foreground transition-colors outline-none"
                            title={item.read ? "Mark as unread" : "Mark as read"}
                          >
                            {!item.read ? (
