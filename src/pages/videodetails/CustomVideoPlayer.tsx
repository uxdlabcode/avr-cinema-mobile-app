      ...
      >
        {!hasActiveMembership ? (
          <div className="absolute inset-0 flex items-center justify-center bg-zinc-950 p-4 z-50">
            <div className={`max-w-md w-full bg-zinc-900/90 border border-zinc-800 rounded-2xl shadow-2xl animate-in zoom-in-95 duration-300 ${
              playInline ? "p-4 space-y-3" : "p-8 space-y-6"
            }`}>
              <div className="flex justify-center">
                <div className={`rounded-full bg-yellow-500/10 flex items-center justify-center border border-yellow-500/25 ${
                  playInline ? "w-10 h-10" : "w-16 h-16"
                }`}>
                  <Crown className={`text-yellow-500 animate-pulse ${
                    playInline ? "w-5 h-5" : "w-8 h-8"
                  }`} />
                </div>
              </div>
              
              <div className="space-y-1">
                <h3 className={`font-bold text-white tracking-tight text-center ${
                  playInline ? "text-sm md:text-base" : "text-xl"
              ...
              <div className={`flex w-full justify-center gap-3 pt-1 ${
                playInline ? "flex-row max-w-xs mx-auto" : "flex-col"
              }`}>
                <button
                  onClick={() => navigate('/membership')}
                  className={`bg-yellow-500 hover:bg-yellow-450 text-black font-bold rounded-lg transition-all shadow-lg shadow-yellow-500/10 active:scale-[0.98] cursor-pointer flex items-center justify-center gap-1.5 ${
                    playInline ? "flex-1 py-1.5 text-[11px] md:text-xs" : "w-full py-3 text-sm"
                  }`}
                >
                ...
                <button
                  ...
                  className={`bg-zinc-800 hover:bg-zinc-750 text-white font-semibold rounded-lg transition-all active:scale-[0.98] cursor-pointer text-center ${
                    playInline ? "flex-1 py-1.5 text-[11px] md:text-xs" : "w-full py-3 text-sm"
                  }`}
                >
                  Go Back
