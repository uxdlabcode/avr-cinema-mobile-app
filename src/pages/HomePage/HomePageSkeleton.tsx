...
export const HomePageSkeleton = () => {
  return (
    <div className="min-h-screen bg-black text-white w-full overflow-hidden pb-20 md:pb-0 animate-pulse">
      ...
      <section className="relative w-full h-[70vh] md:h-[85vh] flex flex-col justify-end">
        ...
        {/* Content placeholder */}
        <div className="relative z-10 flex flex-col items-center text-center px-4 pb-8 md:pb-16 max-w-4xl mx-auto space-y-4">
      ...
      <section className="relative z-20 px-4 md:px-12 space-y-8 mt-2">
        {/* Row 1 */}
        <div>
